...
const Sidebar = () => {
  const sidebarItems = [
    ...
    { text: 'Inventario', link: '/borrar1', icon: <BsBoxSeam className='m-3 text-xl font-bold' /> },
    { text: 'Clientes', link: '/borrar3', icon: <HiOutlineUserGroup className='m-3 text-xl font-bold' /> },
    { text: 'Ventas', link: '/borrar2', icon: <GiPayMoney className='m-3 text-xl font-bold' /> },
    { text: 'Gestión Financiera', link: '/borrar4', icon: <LiaMoneyBillWaveSolid className='m-3 text-xl font-bold' /> },
